...
const quickActions = [
  ...
  { label: 'Manage Staff',        description: 'Add or update your team profiles',          to: '/admin/staff',     icon: StaffIcon },
